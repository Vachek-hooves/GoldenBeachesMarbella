export const BEACHES = [
  {
    ...
    facilities: [
      {
        name: 'Jet Ski Rental',
        text: 'Renting jet skis for fast movement on the water.',
      },
      {
        name: 'Parasailing',
        text: 'Flying on a parachute attached to a boat.',
      },
    ],
  },
  {
    ...
    facilities: [
      {
        name: 'Kayak Rental',
        text: 'Renting kayaks for self-guided water excursions.',
      },
      {
        name: 'Surfing',
        text: 'Surfing lessons with a professional instructor.',
      },
    ],
  },
  {
    ...
    facilities: [
      {
        ...
        text: 'Swimming with dolphins in the Mediterranean Sea.',
      },
      {
        name: 'Sand Sculptures',
        text: 'Workshops for creating sand figures.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    facilities: [
        {
            name: 'Kayaking',
            text: 'Renting kayaks for a peaceful paddle on the water.',
        },
        {
            name: 'Surfing',
            text: 'Surfing lessons with a professional instructor.',
